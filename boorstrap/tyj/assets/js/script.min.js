window.innerWidth < 768 &&
      ...
      !(function () {
        if ('requestAnimationFrame' in window) {
          ...
          for (var n of t) {
            ...
            (o.style.backgroundImage = n.style.backgroundImage),
        ...
        function r() {
          ...
          for (var t = 0; t < e.length; t++) {
            ...
            n.bottom > 0 &&
              ...
              a.push({ rect: n, node: e[t] });
          }
          cancelAnimationFrame(i), a.length && (i = requestAnimationFrame(s));
        }
        function s() {
  ...
  (function (e, t) {
    ...
    var e,
      ...
      v = null,
      p = function (e) {
        -1 !== e.target.id.indexOf('baguette-img') && F();
      },
      h = function (e) {
      ...
      if (b.hasOwnProperty(e)) {
        ...
        [].forEach.call(t, function (e) {
          [].forEach.call(e, function (e) {
            O(e.imageElement, 'click', e.eventHandler);
          }),
            l === e && (l = []);
        }),
          delete b[e];
    ...
    function L(i, s) {
      if (l !== i) {
            ...
            (function (i) {
              ...
              (t.style.transition = t.style.webkitTransition =
                ...
                'auto' === a.buttons &&
                  ...
                  (a.buttons = !1),
                (n.style.display = o.style.display = a.buttons ? '' : 'none');
              try {
        ...
        for (var u, c = [], d = [], f = (m.length = 0); f < i.length; f++)
          ((u = X('div')).className = 'full-image'),
            (u.id = 'baguette-img-' + f),
            m.push(u),
    ...
    function N(t) {
      a.noScrollbars &&
        ...
        'block' !== e.style.display &&
          ...
          a.onChange && a.onChange(u, m.length),
    ...
    function I(e, t) {
      return !c && 0 <= e && e < t.length
        ? (L(t, a), N(e), !0)
        : e < 0
        ? (a.animation && Y('left'), !1)
        : e >= m.length
        ? (a.animation && Y('right'), !1)
        : (P((u = e), function () {
            z(u), M(u);
          }),
          j(),
        ...
        run: function (a, r) {
          return (
            ...
            (function () {
              ...
              (e = X('div')).setAttribute('role', 'dialog'),
                (e.id = 'baguetteBox-overlay'),
                document.getElementsByTagName('body')[0].appendChild(e),
                ((t = X('div')).id = 'baguetteBox-slider'),
                e.appendChild(t),
                (n = X('button')).setAttribute('type', 'button'),
                ...
                (n.innerHTML = s.svg
                  ...
                  : '&lt;'),
                e.appendChild(n),
                (o = X('button')).setAttribute('type', 'button'),
                (o.id = 'next-button'),
                ...
                (o.innerHTML = s.svg
                  ...
                  : '&gt;'),
                e.appendChild(o),
                (i = X('button')).setAttribute('type', 'button'),
                (i.id = 'close-button'),
                ...
                (n.className =
                  ...
                  i.className =
                    'baguetteBox-button'),
                (function () {
                  var a = s.passiveEvents ? { passive: !1 } : null,
                    r = s.passiveEvents ? { passive: !0 } : null;
                  D(e, 'click', p),
                    D(n, 'click', h),
                    D(o, 'click', y),
                    D(i, 'click', w),
                  ...
                  if (
                    ...
                    [].forEach.call(n, function (e, n) {
                      var o = function (e) {
                        ...
                        a = { eventHandler: o, imageElement: e };
                      D(e, 'click', o), i.push(a);
                    }),
                      o.galleries.push(i);
                  }
                }),
